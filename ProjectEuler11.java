public class ProjectEuler11
{
   ...
   public static int calcBig(int r, int c, int[][] matrix)
   {
      int product = 1, big = -1;
      if(r - 3 >= 0)
      {
         for(int row = r - 3; row <= r; row++)
            product *= matrix[row][c];
         if(product > big)
            big = product;
         product = 1;
      }
      ...
      if(c - 3 >= 0)
      {
         for(int col = c - 3; col <= c; col++)
            product *= matrix[r][col];
         if(product > big)
            big = product;
         product = 1;
      }
